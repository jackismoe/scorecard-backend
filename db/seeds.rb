...
puts 'Done. ' + @course_count.to_s + ' courses'

puts 'seeding scores (could take a minute...)'
5000.times do 
  Score.create(score: rand(68...146), player_id: rand(1...@player_count), course_id: rand(1...@course_count))
end
@score_count = Score.count
puts 'Done. ' + @score_count.to_s + ' scores'
